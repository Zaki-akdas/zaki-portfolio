    ...
    <main id="top">
      ...
      <Projects
        projects={(c.projects || [])
          ...
          // Project type carries an optional srcset field for the card cover.
          // Server-side so the client component never needs env vars.
          .map((p) => ({ ...p, cover: thumbOrOriginal(p.cover, 400), coverSrcset: thumbSrcset(p.cover) }))}
      />
